...
function LNOE() {
    ...
    <div className={"flexing-wrapper"}>
        <div className={"section"}>
            ...
            <p className={"LNOE"}>
                Last Night on Earth is a Humans versus Zombies event played over the course of a night in Kortrijk.<br/>
                <br/>
        ...
        <p className={"LNOE"}>
            <il>
                ...
                <li><b>Role Assignment</b>:
                    <ul>
                        <li>Participants will be assigned the role of either a human or a zombie at the beginning of the
                            event.
                            <li>Humans must defend themselves and complete missions to survive.</li>
                            <li>Zombies must infect humans by tagging them.</li>
                            <li>Everybody must wear their (blue) bandana, provided by Tarragon in one of the following
                                locations:
                                <ul>
                            ...
                            <li>All zombies get reflective armbands they must wear around both their upper arms.</li>
                        </li>
                    </ul>
                </li>
                ...
                <li><b>Gameplay</b>:
                    <ul>
                        ...
                        <li>Zombies will attempt to tag humans to turn them into zombies. To accomplish this zombies may
                            run,
                            surround, and otherwise strategize. They may NOT hide in order to ambush, lie about their
                            role, or
                            pretend to be human.
                        </li>
                        <li>Once tagged, humans must call out “HIT!” and raise their hand. They will become zombies and
                            must
                            join
                            the zombie horde. Both the newly infected zombie and the one who tagged them must convene at
                            the
                            bunker
                        ...
                        <li>Humans can stun zombies by tagging them with foam weapons, removing them temporarily.
                            Zombies must
                            call
                            out “HIT!” and raise their hand. They can respawn in their designated zones (zombie hives).
                        </li>
                        <li>Zombies cannot tag in safe zones, designated areas where gameplay is paused. Camping near
                            safe zones
                            is
                            not allowed.
                        </li>
                        <li>Humans must complete missions and objectives to earn points and advance in the game.</li>
                ...
                <li><b>Ending Conditions</b>:
                    <ul>
                        <li>The game ends when either all humans have been turned into zombies, all mission objectives
                            have been
                ...
                <li><b>Code of Conduct</b>:
                    <ul>
                        ...
                        <li>Act like your role. Humans will never want to get infected. Zombies shouldn't have mercy.
                        </li>
                        <li>Have fun, stay active, and embrace the spirit of camaraderie and competition.</li>
                    </ul>
                </li>
            </il>
            These rules are designed to ensure a safe, fair, and enjoyable experience for all participants of Last Night
            on
            Earth.
        </p>
    </div>
